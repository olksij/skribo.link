...
export default function Card({ children, className, type, header, padding, gap, height, outerStyle, innerStyle }: { children: ReactNode[] | ReactNode, className?: string; type?: CardType; header?: { icon: string, title: string }, padding?: string, gap?: string, height?: string, outerStyle?: CSSProperties, innerStyle?: CSSProperties },) {
  ...
  return <div style={{ width: 'inherit', flexDirection: 'column', gap: '12px', height, ...outerStyle }}>
    ...
    <div style={{ ...container, flexDirection: type, padding, gap, height, ...innerStyle }} className={className}> { 
